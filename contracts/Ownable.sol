...
/**
 * @notice Ownable is a inheritable smart contract that will add a
 * New modifier called onlyOwner available in the smart contract inheriting it
 * 
 * onlyOwner makes a funciton only callable from the Token owner
 * 
 */
contract Ownable {
  ...
  * There is no way of restoring the owner
  ...
  /**
  * @notice transferOwnership will asign the {newOwner} as owner
  *
   */
  ...
  /**
  * @notice _transferOwnership will asign the {newOwner} as Owner
  *
   */
